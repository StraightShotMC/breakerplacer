...
public class RegScreenHandlers {
  ...
  public static void init() {
    Registry.register(BuiltInRegistries.MENU, ID("placer_screen_handler"), PLACER_SCREEN_HANDLER);
    Registry.register(BuiltInRegistries.MENU, ID("breaker_screen_handler"), BREAKER_SCREEN_HANDLER);
