...
public class RegScreenHandlers {
  ...
  public static final MenuType<PlacerScreenHandler> PLACER_SCREEN_HANDLER = new ExtendedScreenHandlerType<>(PlacerScreenHandler::new, BlockPos.STREAM_CODEC.cast());
  public static final MenuType<BreakerScreenHandler> BREAKER_SCREEN_HANDLER = new ExtendedScreenHandlerType<>(BreakerScreenHandler::new, BlockPos.STREAM_CODEC.cast());
